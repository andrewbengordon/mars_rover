...
{
    public MultiGameHoster(IMapProvider mapProvider, ILoggerFactory logFactory, MetricHelper metricHelper)
    {
    ...
    public string MakeNewGame()
    {
        ...
        {
            var gameId = nextGame;
            Games.TryAdd(gameId, new GameManager(ParsedMaps, gameLogger, metricHelper));
